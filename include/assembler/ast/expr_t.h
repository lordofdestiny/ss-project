...
namespace m_asm::ast {
    ...
    struct expr_t::visitor_t {
        ...
        virtual void visit_int_literal(expr_t::int_literal_t &op) {
            const_cast<const expr_t::visitor_t *>(this)->visit_int_literal(op);
        }

        virtual void visit_int_literal(expr_t::int_literal_t &) const {

        }

        virtual void visit_symbol(expr_t::symbol_t &op) {
            const_cast<const expr_t::visitor_t *>(this)->visit_symbol(op);
        }

        virtual void visit_symbol(expr_t::symbol_t &) const {}

        virtual void visit_unary(expr_t::unary_t &op) {
            const_cast<const expr_t::visitor_t *>(this)->visit_unary(op);

        }

        virtual void visit_unary(expr_t::unary_t &) const {}

        virtual void visit_sum(expr_t::sum_t &op) {
            const_cast<const expr_t::visitor_t *>(this)->visit_sum(op);
        }

        virtual void visit_sum(expr_t::sum_t &) const {}
    };

    struct expr_t::int_literal_t : expr_t {
        explicit int_literal_t(uint32_t value) : value(value) {}
    ...
    struct expr_t::unary_t : expr_t {
        explicit unary_t(char sign, std::unique_ptr<expr_t> value) :
    ...
    struct expr_t::sum_t : expr_t {
        explicit sum_t(std::unique_ptr<expr_t> left,
                       char op,
